...
class CalcCtrl {
	...
	public function action_calcCompute(){
		...
		if ($this->validate()) {
            ...
            if( $this->form->kwota > 2000 && !inRole('admin') ){
            	    getMessages()->addError('Tylko administrator może wprowadzać kwotę ponad 2000 !');

            	}
            	if( $this->form->op < 10 && !inRole('admin')){
            	    getMessages()->addError('Tylko administrator może wprowadzać opracentowanie mniej niż 10%!');
	...
	public function generateView(){
		...
		getSmarty()->assign('page_header','Kalkulator - role');
